    ...
    public partial class X1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescribedTests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescribedTestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_PrescribedMedicines_PrescribedMedicineId",
                        column: x => x.PrescribedMedicineId,
                        principalTable: "PrescribedMedicines",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Prescriptions_PrescribedTests_PrescribedTestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_PrescribedMedicineId",
                table: "Prescriptions",
                column: "PrescribedMedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_PrescribedTestId",
                table: "Prescriptions",
